...
export default function ClipBoardPage(){
    ...
    <div className='w-full h-[9rem] bg-white rounded-[20px] shadow-xl border-2 border-blue-600 mb-4'>
        ...
        <button className='bg-blue-600 bg-opacity-95 rounded-md shadow-lg text-white px-1 py-1 mx-4 mt-1 w-[90%] h-11'>이미지 추출</button>
        </form>
    </div>
    ...
    <div className='w-full h-[60%] bg-white rounded-[20px] shadow-xl border-2 border-blue-600 py-4 px-4'>
        ...
        <button className='bg-blue-600 bg-opacity-95 rounded-md shadow-lg text-white px-1 py-1 mx-4 mt-1 w-[90%] h-11'>클립보드 비우기</button>
    </div>
    </div>)
}